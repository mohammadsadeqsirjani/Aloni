CREATE VIEW dbo.vw_storePendigToReviewGetList
AS
...
WHERE        (S.fk_status_id = 12)
GO
EXECUTE sp_addextendedproperty @name = N'MS_DiagramPaneCount', @value = 1, @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'VIEW', @level1name = N'vw_storePendigToReviewGetList';
...
Begin DesignProperties = 
   ...
   End
End
', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'VIEW', @level1name = N'vw_storePendigToReviewGetList';
