using AloniServices.Controllers;
            ...
            get
            {
                try
                {
                    ...
                    else if (Request.Properties.ContainsKey(RemoteEndpointMessageProperty.Name))
                    {
                        ...
                        //var prop = Request.Propeties[RemoteEndpointMessageProperty.Name] as RemoteEndpointMessageProperty
                        return prop.Address;
                    }
    ...
    public class Repo : IDisposable
    {
        ...
        public Repo(AdvancedApiController controller, string spName, string funcId, autenticationMode AuthMode = autenticationMode.authenticateAsUser, bool initAsReader = false, bool checkAccess = true)
        {
            ...
            else if (theAutenticationMode == autenticationMode.authenticateAsUser)
            {
                ...
                par_appVersion = cmdA.Parameters.Add("@appVersion", SqlDbType.VarChar,60);
                ...
                //}
                hasAccess =Convert.ToBoolean(par_accessDenied.Value);
        ...
        public string appVersion
        {
            get
            {
                return par_appVersion.Value.dbNullCheckString(); //Convert.ToByte(par_appVersion.Value);
            }
        }
